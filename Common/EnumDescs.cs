...
namespace FTN.Common
{
    public class EnumDescs
    {
	  ...
	  public EnumDescs()
	  {
		...
		property2enumType.Add(ModelCode.CURVE_XMULTPLIER, typeof(UnitMultiplier));
		...
		property2enumType.Add(ModelCode.BINTERVALSCHEDULE_V1MULTIPLIER, typeof(UnitMultiplier));
		property2enumType.Add(ModelCode.BINTERVALSCHEDULE_V1UNIT, typeof(UnitSymbol));
		property2enumType.Add(ModelCode.BINTERVALSCHEDULE_V2MULTIPLIER, typeof(UnitMultiplier));
		property2enumType.Add(ModelCode.BINTERVALSCHEDULE_V2UNIT, typeof(UnitSymbol));
	  }
